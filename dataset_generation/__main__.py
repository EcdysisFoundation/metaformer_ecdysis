...
def main():
    ...
    morphospecies_map.to_csv(dataset_dir / 'morphospecies_map.csv', index=False)
    morphospecies_map.to_csv('deploy/morphospecies_map.csv', index=False) # here too for deployment .mar

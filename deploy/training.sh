...
python -m torchrun --nproc_per_node ${GPU_COUNT} --master_port 12345 main.py --cfg configs/ecdysis_test.yaml \
...
python -m torchrun --nproc_per_node ${GPU_COUNT} --master_port 12345 main.py \
